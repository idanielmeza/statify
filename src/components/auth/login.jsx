...
const Login = () => {
    ...
    const icon = <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-spotify mx-2" viewBox="0 0 16 16">
    ...
    return ( 
        ...
        <div className="container mt-5">
            ...
            <button 
                    onClick={login}
                type="button" className="btn btn-success py-2 mx-auto mt-2 mt-2">
                    {icon}
                    Login with Spotify
                </button>
            </div>
